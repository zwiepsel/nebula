...
namespace Nebula.Clients.FCB.Shared.Models.Client;
    ...
    public class ClientViewModel : ViewModel
    {
        ...
        public virtual ClientTypeViewModel ClientType { get; set; } = null!;
        ...
        public virtual IList<PersonViewModel>? Persons { get; set; } = null!;
        public virtual IList<LeaseAgreementViewModel> LeaseAgreements { get; set; } = null!;

        public LeaseAgreementViewModel? LeaseAgreement => LeaseAgreements.OrderByDescending(leaseAgreement => leaseAgreement.EndDate)
            .FirstOrDefault(leaseAgreement => leaseAgreement.EndDate > DateTime.UtcNow || leaseAgreement.EndDate == null);
