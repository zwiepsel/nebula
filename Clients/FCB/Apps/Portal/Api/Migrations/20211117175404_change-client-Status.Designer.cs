...
namespace Nebula.Clients.FCB.Apps.Portal.Api.Migrations
{
    ...
    [Migration("20211117175404_change-client-Status")]
    partial class changeclientStatus
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Nebula.Clients.FCB.Apps.Portal.Api.Domain.Entities.Process", b =>
                {
                    b.HasOne("Nebula.Clients.FCB.Apps.Portal.Api.Domain.Entities.ProcessStructure", "ProcessStructure")
                        .WithMany("Processes")
                        .HasForeignKey("ProcessStructureId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ProcessStructure");
                });
