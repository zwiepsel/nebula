...
public class HouseRepository : BaseRepository<House, IDatabaseContext>, IHouseRepository
{
    public HouseRepository(IDatabaseContext databaseContext) : base(databaseContext)
    {
    }
}