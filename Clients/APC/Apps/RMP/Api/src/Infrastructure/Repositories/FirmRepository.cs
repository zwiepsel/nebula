...
public class FirmRepository : BaseRepository<Firm, IDatabaseContext>, IFirmRepository
{
    public FirmRepository(IDatabaseContext databaseContext) : base(databaseContext)
    {
    }
}