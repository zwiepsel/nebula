...
public class RiskPossibleOptimizationRepository : BaseRepository<RiskPossibleOptimization, IDatabaseContext>,
    IRiskPossibleOptimizationRepository
{
    public RiskPossibleOptimizationRepository(IDatabaseContext databaseContext) : base(databaseContext)
    {
    }
}