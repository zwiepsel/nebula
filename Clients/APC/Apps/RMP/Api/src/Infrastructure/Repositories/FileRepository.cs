...
public class FileRepository : BaseRepository<File, IDatabaseContext>, IFileRepository
{
    public FileRepository(IDatabaseContext databaseContext) : base(databaseContext)
    {
    }
}