...
public class CosoRepository : BaseRepository<Coso, IDatabaseContext>, ICosoRepository
{
    public CosoRepository(IDatabaseContext databaseContext) : base(databaseContext)
    {
    }
}